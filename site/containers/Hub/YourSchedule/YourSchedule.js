...
import styles from './YourSchedule.css';
      ...
      <div styleName="shell">
        <Section headerSize="thin" headerClip="br:0%,-10%;" headerImage="hero/green.jpg" color="canvas">
          <Block cols="8" background="transparent" styleName="contentShell">
            <h2 style={headcss} >Your Schedule</h2>
            <Block width="100%" background="white" type="padded">
              <Block cols="4">
                <h3>Check back here for your personalized schedule!</h3>
                <p className="bigger">
                ...
                <p>
                  Once we get closer to July, you'll be able to RSVP to the events you're interested
                  in and your custom schedule will appear here.
                </p>
              </Block>
            </Block>
          </Block>
