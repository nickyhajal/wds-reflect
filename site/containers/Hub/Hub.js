        ...
        <Section headerSize="thin" headerClip="br:0%,-10%;" headerImage="hero/green.jpg" color="canvas">
          <div styleName="content">
            <div styleName="sideBtns">
              <SideBtn style={{ backgroundImage: 'url(https://s3.amazonaws.com/el-files-wds/images/photos/when-to-arrive-wds-2019.png)'}} to="/when-to-arrive-in-portland-for-wds-x-2022" />
