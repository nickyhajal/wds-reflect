...
const desktopHeader = (ticketClick, scrollTo, auth, subNav) => (
  <header styleName="header" className={subNav ? 'hasSubNav' : ''}>
    <div styleName="row">
      ...
      <nav styleName="nav">
        <Navlink to="/story" subNav={subNav} onClick={scrollTo} styleName="link">Story</Navlink>
        <Navlink to="/schedule" subNav={subNav} onClick={scrollTo} styleName="link">Schedule</Navlink>
        <Navlink to="/location" subNav={subNav} onClick={scrollTo} styleName="link">Location</Navlink>
        <Navlink to="/academies" subNav={subNav} onClick={scrollTo} styleName="link">Academies</Navlink>
        <Navlink to="/foundation" subNav={subNav} onClick={scrollTo} styleName="link">Foundation</Navlink>
        <Navlink to="/local" subNav={subNav} onClick={scrollTo} styleName="link">WDS Local</Navlink>
      </nav>
      <nav styleName="rightNav">
        { auth.me ?
          <Navlink to="/hub" subNav={subNav} onClick={scrollTo} styleName="link">The Hub</Navlink> :
          <Navlink to="/login" subNav={subNav} onClick={scrollTo} styleName="link">Login</Navlink>
        }
      </nav>
...
const mobileHeader = (ticketClick, scrollTo, navOpen, onMenuClick, auth, subNav) => (
...
const Header = ({
  ticketClick, scrollTo, navOpen, onMenuClick, auth, subNav,
}) => (
  (
    is.mobile() ?
