...
class Tweet extends React.Component {
  ...
  constructor() {
    ...
    this.state  ={
      tweet: `Just setup my attendee profile for WDS! #WDS2018`,
      status: 'ready',
    };
  }
  componentDidMount(props) {
    this.setState({
      tweet: `Just setup my attendee profile for WDS! Check it out: http://wds.fm/~${this.props.auth.me.user_name} #WDS2018`,
    });
  }
  setInp(inp) {
    this.inp = inp;
