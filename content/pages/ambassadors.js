...
>
 <Image src="heading/ambassadors.png" width="470px" height="165px" className="scriptHeader" preload/>
  <Block cols="6" bleed={false} textAlign="left" margin="80px 0 80px">
    ...
    <p>Please note WDS 2017 is taking place from Tuesday July 11th - Monday July 17th. Though we don't expect Ambassadors to be available and serving for all 7 days, we do ask that you:<ul>
  <li>be available for an orientation the evening of Monday, August 8th</li>
  <li>be available the entire weekend of WDS main events from Friday, July 14th to Sunday, July 16th
</ul></p>

So, you want to apply to be a WDS 2017 Ambassador? Awesome! 

<p>Just fill out this brief form and tell us a little bit about yourself <b>(please apply by May 10th)</b>.</p> 
  </Block>
  <Block cols="6">
