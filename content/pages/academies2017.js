...
<Video placeholder="photos/academies2.jpg" videoId="121164251" cols="8" /> 
  <Block cols="6" bleed={false} textAlign="left" margin="80px 0 80px">
    ## The Details 
Registration for Academies is separate from WDS itself and is available to WDS attendees at a heavily discounted rate of $29 each. Academies are also available to the general public for $59 per Academy. (*Please note:* if you are attending WDS, [log in to your WDS account](http://worlddominationsummit.com/login) before making your Academy selection)

Each Academy has a limited number of free "Insider Access" seats only available to early-bird alumni ticket holders (folks who purchased at WDS last August) on a first-come, first-serve basis. If you have access to these seats, you'll see it as an option on each Academy page when you're signed in to your WDS account.

There is no limit to how many Academies you can register for, but please note that you can only purchase Academies for yourself. No physical ticket or confirmation will be required upon check-in, just a valid photo ID. Academy tickets are capacity controlled and offered on a first-come, first-served basis. All tickets are *non-refundable* and *non-transferrable*.
