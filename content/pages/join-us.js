...
>
  ...
  <Block cols="6" className="bigger" mobile={{ all:{ padding: '0 50px', marginBottom: '20px' }, phone: { padding: '0 20px' } }}>
   ...
   All that’s missing is YOU!
    ...
    <p>All tickets cost <b>$697</b> and are sold on a first-come, first-served basis. <i>(For all ticket policies, please refer to our <a href="https://wds.fm/faq">FAQs page</a>)</i></p>
