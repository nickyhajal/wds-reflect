...
>
  ...
  <Grid margin="60px 0 -20px 0">
    <Block type="image" src="photos/Paramount-Hotel.jpg">
      ...
      <p>Book online using the code (WDS17) or call to book (503-223-9900). Be sure to tell them you're with WDS. 0.1 Mi from Base<Link to="https://goo.gl/maps/6D6mJGAY7dv">(Google Directions)</Link></p> 
    ...
    <Block type="image" src="photos/Hotel-Modera-Exterior.jpg">
      ...
      <p>Book online using the group code "WDS2017" or call to book (877.484.1084). Be sure to tell them you're with WDS. 0.1 Mi from Base<Link to="https://goo.gl/maps/T3BnDWTY9oq">(Google Directions)</Link></p> 
