...
>
  ...
  <Grid margin="60px 0 -20px 0">
    <Block type="image" src="photos/society-hotel.jpg">
      ...
      <p>Book online using the group code <b>"WDS17"</b> or call 503.223.9900. Be sure to tell them you're with WDS. 
      0.1 Mi from Base<Link to="https://goo.gl/maps/6D6mJGAY7dv">(Google Directions)</Link></p> 
    ...
    <Block type="image" src="photos/Hotel-Modera-Exterior.jpg">
      ...
      <p>Book online using the group code <b>"WDS2017"</b> or call 877.484.1084. Be sure to tell them you're with WDS. 
      0.1 Mi from Base<Link to="https://goo.gl/maps/T3BnDWTY9oq">(Google Directions)</Link></p> 
