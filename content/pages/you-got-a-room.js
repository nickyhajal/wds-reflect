...
>
  <Block width="768px" bleed={true} type="padded" background="gray" textAlign="left" margin="60px 0 80px" clip="tr:0,1%;">
    <Block width="100%" margin="40px 0 0 0" textAlign="center">## Aw Yeah! Your Booking is Confirmed.</Block>
    
       ###  You Got a Private Room! 
    
    <Block><Image src="wds-hotel/standard-room1.jpg" width="100%" /></Block>
