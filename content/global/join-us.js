<Section color="orange" overflow="hidden">
  ...
  <Button styling="white" align="center" to={(
    window.location.pathname.indexOf('join-us') > -1 ? '/connect' : '/connect'
  )} style={{ width: '260px', margin: '60px auto 110px', padding: '20px 0', fontSize: '21px', fontFamily: 'VitesseBold' }}>Get Your Connect Ticket!</Button>
